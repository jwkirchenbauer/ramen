...
exp_name=bert-base-uncased_to_flaubert
...
# python get_hf_tokenizers.py --src_name $src_name --tgt_name $tgt_name --src_hf_name $src_hf_name --tgt_hf_name $tgt_hf_name --base_save_path $BASE_TOKENIZER_SAVE_PATH

# python get_prob_vect.py --src_aligned_vec $VEC_PATH/cc.$src_lg.300.vec --src_vocab $BASE_TOKENIZER_SAVE_PATH/$src_name/$src_name-vocab.$src_ftype --topn 50000 --tgt_aligned_vec $VEC_PATH/aligned.$tgt_lg.vec --tgt_vocab $BASE_TOKENIZER_SAVE_PATH/$tgt_name/$tgt_name-vocab.$tgt_ftype --save $PROB_PATH/probs.mono.$src_name-to-$tgt_name.pth
